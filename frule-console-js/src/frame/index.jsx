                        ...
                        <div style={{
                            ...
                            <span className="dropdown" style={{margin: '5px'}}>
                                <a href="#" className="dropdown-toggle" data-toggle="dropdown" title="知识库内容展示方式">
                                    <i className="rf rf-display" style={{fontSize: '12pt'}}/>
                                    <b className="caret"/></a>
                            ...
                            <span className="dropdown" style={{margin: '5px'}}>
                                ...
                                <ul className="dropdown-menu">
                                    ...
                                    }}><i className="filter_file rf rf-check"/> <i
                                        className="glyphicon glyphicon-th"/> 显示所有文件</a></li>
                                    <li>
                                        <a href="#" onClick={function (e) {
                                            componentEvent.eventEmitter.emit(componentEvent.SHOW_LOADING);
                                            window._types = 'lib';
                            ...
                            <span className="dropdown" style={{margin: '5px'}}>
                                <a href="#" className="dropdown-toggle" data-toggle="dropdown" title="权限配置"><i
                                    className="rf rf-authority" style={{fontSize: '12pt'}}/> <b
                                    className="caret"/></a>
