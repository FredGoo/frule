...
import {LOAD_END, lockFile, seeFileSource, unlockFile} from "../../frame/action.js";
...
const frame = {
    ...
    actions: {
        loadData({commit, dispatch}, classify, projectName, types, searchFileName) {
